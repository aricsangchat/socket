...
function handleBuySell(time, close, last) {
  ...
  console.log('sot99',settings.orderTrend99);
  console.log('sot97',settings.orderTrend97);
  console.log('sot95',settings.orderTrend95);
...
function mapPercentage(trace1, trace2, trace3, trace4, trace5, trace6, time, close, io) {
  ...
  io.emit('chart', percentageData, 'Percent');
}
